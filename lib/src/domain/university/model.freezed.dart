...
class _$SubjectImpl with DiagnosticableTreeMixin implements _Subject {
  const _$SubjectImpl({required this.id, required this.title});
...
abstract class _Subject implements Subject {
  const factory _Subject(
      {required final String id, required final String title}) = _$SubjectImpl;
...
class _$ContentImpl with DiagnosticableTreeMixin implements _Content {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Content(id: $id, subjectId: $subjectId, title: $title, fileName: $fileName, fileUrl: $fileUrl, description: $description)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, subjectId, title, fileName, fileUrl, description);
...
abstract class _Content implements Content {
  const factory _Content(
      ...
      required final String? description}) = _$ContentImpl;
